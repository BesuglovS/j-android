package ru.nayanovaacademy.journal.di

import android.content.Context
import androidx.room.Room
import com.google.gson.Gson
import ru.nayanovaacademy.journal.data.api.AuthInterceptor
import ru.nayanovaacademy.journal.data.api.JournalApi
import ru.nayanovaacademy.journal.data.local.AppDatabase
import ru.nayanovaacademy.journal.data.local.CacheDao
import ru.nayanovaacademy.journal.data.local.PendingChangeDao
import ru.nayanovaacademy.journal.data.api.ScheduleApi
